...
INSERT INTO games (id, opponent, starts_at, actual_score) VALUES
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', 'Demo State', unixepoch() - 1209600, 35),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', 'Example Tech', unixepoch() - 604800, 24),
  ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'Future University', unixepoch() + 604800, NULL);
